<template>
  <div>
    <main>
          ...
          <div class="row align-items-center">
            <div class="col-lg-5 order-2 order-lg-1">
              <div class="about-inner">
                <h2 class="h1 title">
                  <span>Provide</span> the Best <br />
                  Solutions <span>to Improve</span> <br />your Business
                </h2>
                <h3 class="subtitle">
          ...
          <div class="row">
            <div class="col-12">
              <div class="section-title section-title--style_2 text-center">
                <h2 class="h1 title">
                  Sucessfully <span>completed</span> 2100+
          ...
          <div class="row align-items-center">
            ...
            <div class="col-xl-5 offset-xl-1 order-1 order-xl-2">
              <div class="team-content team-content--style_2 about-inner">
                <h2 class="h1 title">
                  We have <span>Creative</span> Team<br />
      ...
      <section
        class="testimonial-wrapper testimonial-wrapper--style_2 section-padding pt-0 fix"
      >
        <div class="container">
          <div class="row align-items-center">
            <div
              class="col-xl-5 col-lg-5 order-2 order-lg-1 wow fadeInLeft"
              data-wow-duration="1s"
              data-wow-delay=".5s"
            >
              <div class="testimonial-inner mt-0">
                <h2 class="h1 title">
                  What <span>Client’s</span> say <br />
                  happy reviews
                </h2>
                <h3 class="subtitle">
                  Create some exclusive way to solve our customer problems
                ...
                >
                  ...
                  <div class="testimonial-item testimonial-item--style_2">
                    <div class="testimonial-content">
                      <p>
                        <i class="fa fa-quote-left"></i>labore et dolore magnam
                        aliquam quaerat voluptatem. ad minima veniam, quis
                        nostrum exercitationem ullam uscipit laboriosam, nisi ex
                        ea commodi consequatur <i class="fa fa-quote-right"></i>
                      </p>
            ...
            <div
              class="col-xl-6 col-lg-7 offset-xl-1 order-1 order-lg-2 wow fadeInRight"
              data-wow-duration="1s"
              data-wow-delay=".5s"
            >
