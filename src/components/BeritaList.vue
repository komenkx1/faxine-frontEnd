                    ...
                    <div class="row mtn-40">
                        ...
                        <div class="col-lg-9 order-1 order-lg-2 pl-lg-45 ">
                            <div class="row">
                                ...
                                <div class="col-md-6" v-for="berita in beritaDatas" :key="berita.id">
                                    <div class="blog-item mt-40">
                                        ...
                                        <div class="blog-content">
                                            <h3 class="blog-title">
                                                <router-link :to="'/Berita/'+ berita.id">{{berita.judul}}</router-link>
                                            </h3>
                                            <p>{{berita.content}}</p>
                                            <div class="blog-meta">
                                                <router-link :to="'/Berita/'+ berita.id">{{berita.tanggal_pembuatan}}</router-link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
